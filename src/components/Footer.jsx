...
function Footer() {
  return (
    <div className='flex w-full h-screen bg-zinc-900 p-20 font-["Founders_Grotesk_X"]'>
      <div className='w-1/2 h-full flex flex-col justify-between'>
        <div className='heading '>
          <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-10'>Eye-</h1>
          <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-10'>Opening</h1></div>
